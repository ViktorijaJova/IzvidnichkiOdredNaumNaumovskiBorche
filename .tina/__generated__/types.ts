...
export type PagesPageBlocksArticlesBlog = {
  __typename?: 'PagesPageBlocksArticlesBlog';
  articleNo?: Maybe<Scalars['Float']>;
...
export type PagesPageBlocksDescription = {
  __typename?: 'PagesPageBlocksDescription';
  theDescription?: Maybe<Scalars['JSON']>;
};

export type PagesPageBlocksSmallHero = {
  __typename?: 'PagesPageBlocksSmallHero';
  smallHeroTitle?: Maybe<Scalars['JSON']>;
  smallBackgroundImage?: Maybe<Scalars['String']>;
  smallBackgroundImageAlt?: Maybe<Scalars['String']>;
};

export type PagesPageBlocksWhatYouGetGains = {
  __typename?: 'PagesPageBlocksWhatYouGetGains';
  gainsName?: Maybe<Scalars['String']>;
  gainsDescription?: Maybe<Scalars['String']>;
  gainsImage?: Maybe<Scalars['String']>;
};

export type PagesPageBlocksWhatYouGet = {
  __typename?: 'PagesPageBlocksWhatYouGet';
  whatYouGetTitle?: Maybe<Scalars['JSON']>;
  whatYouGetDescription?: Maybe<Scalars['JSON']>;
  gains?: Maybe<Array<Maybe<PagesPageBlocksWhatYouGetGains>>>;
};
...
export type PagesPageBlocks = PagesPageBlocksSpacing | PagesPageBlocksArticlesBlog | PagesPageBlocksTitleDescription | PagesPageBlocksDescription | PagesPageBlocksSmallHero | PagesPageBlocksWhatYouGet | PagesPageBlocksHomepageHero | PagesPageBlocksAdventure | PagesPageBlocksTwoImages | PagesPageBlocksImage | PagesPageBlocksImageTwo | PagesPageBlocksContentVideo | PagesPageBlocksLeftImageRightLinks;
...
export type PagesPageBlocksArticlesBlogMutation = {
  articleNo?: InputMaybe<Scalars['Float']>;
...
export type PagesPageBlocksDescriptionMutation = {
  theDescription?: InputMaybe<Scalars['JSON']>;
};

export type PagesPageBlocksSmallHeroMutation = {
  smallHeroTitle?: InputMaybe<Scalars['JSON']>;
  smallBackgroundImage?: InputMaybe<Scalars['String']>;
  smallBackgroundImageAlt?: InputMaybe<Scalars['String']>;
};

export type PagesPageBlocksWhatYouGetGainsMutation = {
  gainsName?: InputMaybe<Scalars['String']>;
  gainsDescription?: InputMaybe<Scalars['String']>;
  gainsImage?: InputMaybe<Scalars['String']>;
};

export type PagesPageBlocksWhatYouGetMutation = {
  whatYouGetTitle?: InputMaybe<Scalars['JSON']>;
  whatYouGetDescription?: InputMaybe<Scalars['JSON']>;
  gains?: InputMaybe<Array<InputMaybe<PagesPageBlocksWhatYouGetGainsMutation>>>;
};
...
export type PagesPageBlocksMutation = {
  ...
  smallHero?: InputMaybe<PagesPageBlocksSmallHeroMutation>;
  whatYouGet?: InputMaybe<PagesPageBlocksWhatYouGetMutation>;
